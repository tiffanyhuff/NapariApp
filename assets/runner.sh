...
echo "TACC: Your DCV session is now running!" > $STOCKYARD/napari_dcvserver.txt
echo "TACC: To connect to your DCV session, please point a modern web browser to:" >> $STOCKYARD/napari_dcvserver.txt
echo "TACC:          https://ls6.tacc.utexas.edu:$LOGIN_PORT" >> $STOCKYARD/napari_dcvserver.txt
...
echo "TACC: job $SLURM_JOB_ID execution finished at: `date`"
rm $STOCKYARD/napari_dcvserver.txt
